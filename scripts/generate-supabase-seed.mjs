...
const RECIPE_COLUMNS = [
  ...
  "occasion", "kid_favourite", "plancha",
];
...
const RECIPE_COLUMN_TYPES = {
  ...
  occasion: "text", kid_favourite: "boolean", plancha: "boolean",
};
...
const recipeRows = recipes.map((r) => {
  return `  (${sqlString(r.id)}, ${sqlString(r.name)}, ${sqlString(r.category)}, ${sqlString(r.mainProtein)}, ` +
    ...
    `${sqlNullableBool(r.estrella)}, ${sqlString(r.occasion)}, ${sqlNullableBool(r.kidFavourite)}, ${sqlNullableBool(r.plancha)})`;
});
