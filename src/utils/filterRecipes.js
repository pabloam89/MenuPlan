...
// catálogo original ("fondo de armario") se queda como fallback — solo entra
// si las restricciones del grupo agotan el pool principal. La señal es el
// flag `estrella` (recipeSchema.js), marcado a mano — NO "¿tiene foto?": esa
// señal se usó hasta que un fix puramente visual (conectar una foto huérfana
// que ya existía en Blob) promovió sin querer ~200 recetas del fondo de
// armario al pool principal de golpe, sin que nadie lo decidiera. Una receta
// propia del usuario siempre cuenta como "principal".
