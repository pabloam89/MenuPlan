...
export const OPERADORES = [
  ...
  { id: "deriveStepParts", tipo: "clasificador", modulo: "src/lib/derive/stepParts.js", entrada: ["recetas.stepsRich", "ingredientes.aisle", "recetas.mainProtein"], salida: "stepsRich[].part (derivado)", determinista: true, nota: "por FK y aisle; el texto plano del paso solo se lee cuando ningún marcador vota. 59,1 % de concordancia contra las curadas: se mide, no se escribe" },
